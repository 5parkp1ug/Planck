            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        ...
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-audio-description" aria-hidden="true"></i> audio-description</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-car" aria-hidden="true"></i> automobile <span className="text-muted">(alias)</span></div>
                        ...
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fas fa-file-archive" aria-hidden="true"></i> file-archive</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-audio" aria-hidden="true"></i> file-audio-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-code" aria-hidden="true"></i> file-code-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-excel" aria-hidden="true"></i> file-excel-o</div>
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        ...
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-archive" aria-hidden="true"></i> file-archive-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-audio" aria-hidden="true"></i> file-audio-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-code" aria-hidden="true"></i> file-code-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-excel" aria-hidden="true"></i> file-excel-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-image" aria-hidden="true"></i> file-image-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-movie" aria-hidden="true"></i> file-movie-o <span class="text-muted">(alias)</span></div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file" aria-hidden="true"></i> file-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-pdf" aria-hidden="true"></i> file-pdf-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-photo" aria-hidden="true"></i> file-photo-o <span class="text-muted">(alias)</span></div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-picture" aria-hidden="true"></i> file-picture-o <span class="text-muted">(alias)</span></div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-powerpoint" aria-hidden="true"></i> file-powerpoint-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-sound" aria-hidden="true"></i> file-sound-o <span class="text-muted">(alias)</span></div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-text" aria-hidden="true"></i> file-text</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-text" aria-hidden="true"></i> file-text-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-video" aria-hidden="true"></i> file-video-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-word" aria-hidden="true"></i> file-word-o</div>
                        <div class="fa-hover col-md-3 col-sm-4"><i class="fa fa-fw fa-file-zip" aria-hidden="true"></i> file-zip-o <span class="text-muted">(alias)</span></div>
                    </Row>
                </CardBody>
            </Card>
            { /* END Card */}  
