            ...
            <nav className="sidebar sidebar-offcanvas" id="sidebar">
                ...
                <ul className="nav">
                    ...
                    <li className={this.isPathActive('/analytics') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
                        <div className={this.state.analyticsMenuOpen ? 'nav-link menu-expanded' : 'nav-link'}
                             onClick={() => this.toggleMenuState('analyticsMenuOpen')} data-toggle="collapse">
              <span className="menu-icon">
                <i className="mdi mdi-chart-areaspline"></i>
                            ...
                            <div>
                                <ul className="nav flex-column sub-menu">
                                    <li className="nav-item"><Link
                                        className={this.isPathActive('/analytics/overview') ? 'nav-link active' : 'nav-link'}
                                        to="/analytics/overview">Overview</Link></li>
                                    <li className="nav-item"><Link
                                        className={this.isPathActive('/analytics/geographic') ? 'nav-link active' : 'nav-link'}
                                        to="/analytics/geographic">Geographic</Link></li>
                                    <li className="nav-item"><Link
                                        className={this.isPathActive('/analytics/device') ? 'nav-link active' : 'nav-link'}
                                        to="/analytics/device">Device</Link></li>
                                </ul>
                            </div>
                        </Collapse>
                    </li>
                    ...
                    <li className={this.isPathActive('/settings') ? 'nav-item menu-items active' : 'nav-item menu-items'}>
                        <div className={this.state.settingsMenuOpen ? 'nav-link menu-expanded' : 'nav-link'}
                             onClick={() => this.toggleMenuState('settingsMenuOpen')} data-toggle="collapse">
              <span className="menu-icon">
                <i className="mdi mdi-settings"></i>
                        ...
                        <Collapse in={this.state.settingsMenuOpen}>
                            <div>
                                <ul className="nav flex-column sub-menu">
                                    <li className="nav-item"><Link
                                        className={this.isPathActive('/settings/profile') ? 'nav-link active' : 'nav-link'}
                                        to="/settings/profile">Profile</Link></li>
                                    <li className="nav-item"><Link
                                        className={this.isPathActive('/settings/advanced') ? 'nav-link active' : 'nav-link'}
                                        to="/settings/advanced">Advanced</Link></li>
                                </ul>
                            </div>
                        </Collapse>
                    </li>
                    ...
                    <li className="nav-item menu-items">
                        <a className="nav-link" href="https://github.com/5parkp1ug/Planck/blob/master/README.md"
